...
describe('__name__Service', () => {
    ...
    describe('get__name__', () => {
        ...
        it('should be successful', async(() => {
            service.getSomethingNew().subscribe((responseModel: SomethingNewResponseModel) => {
                expect(responseModel).toEqual(jasmine.any(SomethingNewResponseModel));
            });
        ...
        it('should error', async(() => {
            service.getSomethingNew().subscribe((responseModel: HttpErrorResponse) => {
